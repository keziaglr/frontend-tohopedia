...
import { CREATE_GLOBAL_VOUCHER } from '../../graphql/user/Mutations';

export function VoucherManagementGlobal(){
    const [createGlobalVoucher] = useMutation(CREATE_GLOBAL_VOUCHER)
    return (
